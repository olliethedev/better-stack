...
│  │   Frontend       │         │   Backend        │         │
│  │──────────────────│         │──────────────────│         │
│  │  Plugin Routes   │────────▶│ API Route Handler│         │
│  │  (Pages)         │  HTTP   │ (/api/*)         │         │
│  │                  │         │                  │         │
│  │  React Query ────┼────────▶│  DB Adapter ─────┼─────────┼───▶ Database
│  │  (Data Fetch)    │         │  (ORM Bridge)    │         │
│  │                  │         │                  │         │
│  │  Overrides       │         │  DB Schemas      │         │
│  │  (Framework)     │         │  (Merged)        │         │
│  └──────────────────┘         └──────────────────┘         │
│                                                            │
└────────────────────────────────────────────────────────────┘
...
<Steps>
  ...
  <Step>
    ...
    - ✅ Framework-specific overrides for optimal DX
    ...
    **Example projects:**
    ...
    - **[Next.js Example](https://github.com/olliethedev/better-stack/tree/main/examples/nextjs)** - Full Next.js App Router setup with blog and todo plugins
    - **[React Router Example](https://github.com/olliethedev/better-stack/tree/main/examples/react-router)** - React Router v7 setup with SSR support
    - **[TanStack Start Example](https://github.com/olliethedev/better-stack/tree/main/examples/tanstack)** - TanStack Router setup with file-based routing
